...
func _ready():
	...
	save_data.store_line("2")
	save_data.close()
	
func restart_level():
	print("restart game:", get_tree().change_scene("res://Scenes/Levels/level_2.tscn"))
...
func _on_next_level_body_entered(body):
	if body.name == "Player":
		print("next level:", get_tree().change_scene("res://Scenes/Levels/level_1.tscn"))
